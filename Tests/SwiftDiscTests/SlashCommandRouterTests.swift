...
final class SlashCommandRouterTests: XCTestCase {
    func testSubcommandPathAndOptions() async throws {
        ...
        let interaction = Interaction(id: "1", application_id: "app", type: .applicationCommand, data: data, guild_id: "guild", channel: nil, channel_id: "chan", member: nil, user: nil, token: "tok", version: nil, message: nil, app_permissions: nil, locale: nil, guild_locale: nil, authorizing_integration_owners: nil, context: nil)
