...
public struct PermissionBitset: OptionSet, Codable, Hashable, Sendable {
    ...
    public static let useSoundboard = PermissionBitset(rawValue: 1 << 45)
    public static let useExternalSounds = PermissionBitset(rawValue: 1 << 46)
    public static let sendVoiceMessages = PermissionBitset(rawValue: 1 << 47)
