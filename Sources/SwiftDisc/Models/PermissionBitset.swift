...
public struct PermissionBitset: OptionSet, Codable, Hashable, Sendable {
    ...
    public static let viewCreatorMonetizationAnalytics = PermissionBitset(rawValue: 1 << 41)
    public static let useSoundboard = PermissionBitset(rawValue: 1 << 42)
    ...
    public static let useExternalSounds = PermissionBitset(rawValue: 1 << 45)
    public static let sendVoiceMessages = PermissionBitset(rawValue: 1 << 46)
    public static let manageScheduledEvents = PermissionBitset(rawValue: 1 << 48)
    public static let sendPolls = PermissionBitset(rawValue: 1 << 49)
