...
public struct Embed: Codable, Hashable, Sendable {
    public struct Footer: Codable, Hashable, Sendable { public let text: String; public let icon_url: String? }
    ...
    public struct Image: Codable, Hashable, Sendable { public let url: String }
